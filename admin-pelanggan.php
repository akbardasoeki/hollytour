        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <?php 
            ...
            if (@$_GET['status']!==NULL) {
              $status = $_GET['status'];
              if ($status=='ok') {
                echo '<br><br><div class="alert alert-success" role="alert">Customer list updated</div>';
              }
              elseif($status=='err'){
                echo '<br><br><div class="alert alert-danger" role="alert">Customer list failed to update</div>';
              }

            }
           ?>
          <h2 style="margin: 30px 0 30px 0;">Customer List</h2>
                ...
                <?php 
                 ...
                 <?php while($data = $result->fetch(PDO::FETCH_ASSOC) ): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo "admin-update-pelanggan.php?id_user=".$data['id_user']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                      &nbsp;&nbsp;
                      <a href="<?php echo "admin-delete-pelanggan.php?id_user=".$data['id_user']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                 <?php endwhile ?>
              </tbody>
